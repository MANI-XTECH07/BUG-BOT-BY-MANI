...
const BOT_NAME_FANCY = ' ϟ DEVIL KILLER ✯꧂';
...
╭───❏ *${botName}* ❏
│  ✅ *Status*  : Online & Ready
│  👑 *Owner*   : ${config.OWNER_NAME || '𝙼𝙰𝙽𝙸 𝚇𝚃𝙴𝙲𝙷 ⚚'}
...
> 𝙳𝙴𝚅𝙸𝙻 𝙺𝙸𝙻𝙻𝙴𝚁 ⚚ ʙᴇᴛᴀ ᴛʜɪꜱ ɪꜱ ᴛᴇꜱᴛɪɴɢ ʙᴏᴛ 
> ᴍᴀᴅᴇ ʙʏ 𝙼𝙰𝙽𝙸-𝚇𝚃𝙴𝙲𝙷 
> ᴛʜᴀɴᴋꜱ ᴜꜱ𝙸ɴɢ ᴍʏ ᴛᴏᴏʟ ᴀɴᴅ ʙᴏᴛꜱ
...
│  ${config.PREFIX}alive
╰───────────────────────────────❏
>  ${config.BOT_FOOTER || '♡⸝⸝> ̫ <⸝⸝♡ 𝙳𝙴𝚅𝙸𝙻 𝐊ɪʟʟᴇʀ'}
`.trim();
...
case 'owner': {
  ...
  try {
    ...
    const title = userCfg.botName || '♡⸝⸝> ̫ <⸝⸝♡ 𝙳𝙴𝚅𝙸𝙻 𝙺𝙸𝙻𝙻𝙴𝚁';
